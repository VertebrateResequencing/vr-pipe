...
class VRPipe::Steps::penncnv_detect_cnv with VRPipe::StepRole {
    method options_definition {
        return {
            detect_cnv_script => VRPipe::StepOption->create(description => 'full path to detect_cnv.pl',                                             optional => 1, default_value => '/software/vertres/bin-external/PennCNV/detect_cnv.pl'),
            detect_cnv_hmm    => VRPipe::StepOption->create(description => 'full path to custom.hmm',                                                optional => 1, default_value => '/lustre/scratch105/vrpipe/refs/human/ncbi37/resources_hipsci/genotyping/PennCNV/lib/custom.hmm'),
            detect_cnv_pfb    => VRPipe::StepOption->create(description => 'full path to PFB',                                                       optional => 1, default_value => '/lustre/scratch105/vrpipe/refs/human/ncbi37/resources_hipsci/genotyping/PennCNV/lib/HumanExome12v1.1.hg19.pfb'),
