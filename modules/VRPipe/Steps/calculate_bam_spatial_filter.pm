...
set consistent thresholds for all bams in the lane. Creation of a seperate
filter for each bam is probably not to be recommended.
    ...
    method options_definition {
        return {
            tag_number => VRPipe::StepOption->create(
                description => 'Generate a lane-wide filter from this tag, eg the tag 168 (phiX control) file',
