...
Associates metadata with vcf files in the VRPipe database, making the file
usable in other vcf-related Steps. A basic implementation which may be mofified
in future to include vcf-check output.
