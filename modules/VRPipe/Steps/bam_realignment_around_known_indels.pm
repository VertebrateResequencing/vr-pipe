    ...
    method body_sub {
        return sub {
            ...
            foreach my $bam (@{ $self->inputs->{bam_files} }) {
                ...
                my $this_cmd = $self->java_prefix($req->memory, $temp_dir) . qq[ -T IndelRealigner -R $ref -I ] . $bam->path . qq[ -o ] . $realigned_bam_file->path . qq[ -targetIntervals $intervals_file $known_indels $realign_opts];
