...
VRPipe::Pipelines::gvcf_calling_two_combine_with_gatk_haplotype_caller_with_vep
- a pipeline
...
class VRPipe::Pipelines::gvcf_calling_two_combine_with_gatk_haplotype_caller_with_vep with VRPipe::PipelineRole {
    method name {
        return 'gvcf_calling_two_combine_with_gatk_haplotype_caller_with_vep';
    }
    
    method description {
        return 'Run GATK to combine and genotype gVCF files and run Variant Effect Predictor (VEP). Use this pipeline for more than 40,000 samples.';
    }
    ...
    method adaptor_definitions {
        (
            ...
            { from_step => 4, to_step => 5, from_key => 'vep_annot_vcf_files', to_key => 'vcf_files' },
        );
    }
    ...
    method behaviour_definitions {
        (
            ...
            { after_step => 5, behaviour => 'delete_outputs', act_on_steps => [4], regulated_by => 'delete_gvcf_chunks', default_regulation => 1 },
        );
    }
