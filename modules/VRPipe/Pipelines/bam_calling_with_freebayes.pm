...
VRPipe::Pipelines::bam_calling_with_freebayes - a pipeline
...
class VRPipe::Pipelines::bam_calling_with_freebayes with VRPipe::PipelineRole {
    method name {
        return 'bam_calling_with_freebayes';
    }
    
    method description {
        return 'Run freebayes split over the genome and concatenate the results.';
    }
