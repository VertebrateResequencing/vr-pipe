...
VRPipe::Pipelines::gvcf_calling_one_combine_with_gatk_haplotype_caller - a
pipeline
...
class VRPipe::Pipelines::gvcf_calling_one_combine_with_gatk_haplotype_caller with VRPipe::PipelineRole {
    method name {
        return 'gvcf_calling_one_combine_with_gatk_haplotype_caller';
    }
    
    method description {
        return 'Run GATK to combine and genotype gVCF files. Use this pipeline for up to 40,000 samples.';
    }
