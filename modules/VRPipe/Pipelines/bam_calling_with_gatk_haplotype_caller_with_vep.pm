...
VRPipe::Pipelines::bam_calling_with_gatk_haplotype_caller_with_vep - a pipeline
...
class VRPipe::Pipelines::bam_calling_with_gatk_haplotype_caller_with_vep with VRPipe::PipelineRole {
    method name {
        return 'bam_calling_with_gatk_haplotype_caller_with_vep';
    }
    
    method description {
        return 'Run GATK Haplotype Caller split over the genome and concatenate results; BAM and BAI files required as input. Also run Variant Effect Predictor (VEP).';
    }
