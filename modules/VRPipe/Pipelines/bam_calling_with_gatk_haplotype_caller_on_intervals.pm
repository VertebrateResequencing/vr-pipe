...
VRPipe::Pipelines::bam_calling_with_gatk_haplotype_caller_on_intervals - a
pipeline
...
class VRPipe::Pipelines::bam_calling_with_gatk_haplotype_caller_on_intervals with VRPipe::PipelineRole {
    method name {
        return 'bam_calling_with_gatk_haplotype_caller_on_intervals';
    }
    
    method description {
        return 'Run GATK HaplotypeCaller across multiple intervals files and concatenate the resutls';
    }
    
    method step_names {
        (
            'gatk_haplotype_caller_on_intervals', #1
            'bcf_concat',                         #2
        );
    }
