...
VRPipe::Pipelines::fastq_mapping_with_bwa_mem - a pipeline
...
class VRPipe::Pipelines::fastq_mapping_with_bwa_mem with VRPipe::PipelineRole {
    method name {
        return 'fastq_mapping_with_bwa_mem';
    }
    
    method description {
        return 'Map reads in fastq files to a reference genome with bwa mem';
    }
    ...
    method adaptor_definitions {
        (
            ...
            { from_step => 4, to_step => 5,  from_key => 'local_fastq_files', to_key => 'fastq_files' },
    ...
    method behaviour_definitions {
        (
            { after_step => 7, behaviour => 'delete_outputs', act_on_steps => [4, 6], regulated_by => 'cleanup', default_regulation => 1 },
