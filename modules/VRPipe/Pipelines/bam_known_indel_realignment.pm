...
VRPipe::Pipelines::bam_known_indel_realignment - a pipeline
...
class VRPipe::Pipelines::bam_known_indel_realignment with VRPipe::PipelineRole {
    method name {
        return 'bam_known_indel_realignment';
    }
    
    method description {
        return 'GATK indel realignment around known indels. BAM and BAI files required as input. Do not set --disable_bam_indexing in any of the GATK step options';
    }
