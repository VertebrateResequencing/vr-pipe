...
VRPipe::Pipelines::rna_seq_star_bam_realignment - a pipeline
...
class VRPipe::Pipelines::rna_seq_star_bam_realignment with VRPipe::PipelineRole {
    method name {
        return 'rna_seq_star_bam_realignment';
    }
