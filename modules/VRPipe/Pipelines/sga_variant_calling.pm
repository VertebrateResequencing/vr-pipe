    ...
    method _step_list {
        return ([
                ...
                [
                    ...
                    VRPipe::StepAdaptorDefiner->new(from_step => 4, to_step => 5, from_key => 'merged_fastq_file', to_key => 'fastq_files'),
                ...
                [
                    ...
                    VRPipe::StepBehaviourDefiner->new(after_step => 6, behaviour => 'delete_outputs', act_on_steps => [4,5], regulated_by => 'cleanup', default_regulation => 0),
                ]);
    }
}
