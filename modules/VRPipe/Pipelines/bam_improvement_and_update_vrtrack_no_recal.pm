    ...
    method _step_list {
        return ([ VRPipe::Step->get(name => 'sequence_dictionary'),#1
                ...
                [ VRPipe::StepAdaptorDefiner->new(from_step => 0, to_step => 2, to_key => 'bam_files'),
                  ...
                  VRPipe::StepAdaptorDefiner->new(from_step => 6, to_step => 7, from_key => 'bq_bam_files', to_key => 'bam_files'),
                  VRPipe::StepAdaptorDefiner->new(from_step => 1, to_step => 7, from_key => 'reference_dict', to_key => 'dict_file'),
                  VRPipe::StepAdaptorDefiner->new(from_step => 7, to_step => 8, from_key => 'headed_bam_files', to_key => 'bam_files')
                  ],
