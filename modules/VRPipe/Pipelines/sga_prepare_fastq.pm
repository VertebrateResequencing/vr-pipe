    ...
    method _step_list {
        return ([
                ...
                [
                    ...
                    VRPipe::StepAdaptorDefiner->new(from_step => 1, to_step => 2, from_key => 'split_bam_files', to_key => 'bam_files'),
                    VRPipe::StepAdaptorDefiner->new(from_step => 1, to_step => 3, from_key => 'split_bam_files', to_key => 'bam_files'),
                    VRPipe::StepAdaptorDefiner->new(from_step => 3, to_step => 4, from_key => 'fastq_files', to_key => 'fastq_files'),
                ],
                [
