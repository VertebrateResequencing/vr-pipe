...
VRPipe::Pipelines::sequencing_qc_from_irods - a pipeline
...
class VRPipe::Pipelines::sequencing_qc_from_irods with VRPipe::PipelineRole {
    method name {
        return 'sequencing_qc_from_irods';
    }
    
    method description {
        return 'Parse cram qc files stored in irods by NPG.';
    }
