...
class VRPipe::Pipelines::bam_mapping_with_stampy with VRPipe::PipelineRole {
    ...
    method _step_list {
        return ([ VRPipe::Step->get(name => 'sequence_dictionary'), #1
                  ...
                  VRPipe::Step->get(name => 'bam_reheader'), #11
                  VRPipe::Step->get(name => 'bam_stats') #12
                 ],
                 
                 [ VRPipe::StepAdaptorDefiner->new(from_step => 0, to_step => 5, to_key => 'bam_files'),
                   VRPipe::StepAdaptorDefiner->new(from_step => 5, to_step => 6, from_key => 'bam_files_with_metadata', to_key => 'bam_files'),
                   ...
                   VRPipe::StepAdaptorDefiner->new(from_step => 11, to_step => 12, from_key => 'headed_bam_files', to_key => 'bam_files') ],
