...
class VRPipe::Pipelines::vrtrack_auto_qc with VRPipe::PipelineRole {
    ...
    method _step_list {
        return ([VRPipe::Step->get(name => 'vrtrack_auto_qc')], [VRPipe::StepAdaptorDefiner->new(from_step => 0, to_step => 1, to_key => 'bam_files'), VRPipe::StepAdaptorDefiner->new(from_step => 0, to_step => 1, to_key => 'bamcheck_files')], []);
    }
}
