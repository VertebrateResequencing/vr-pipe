...
class VRPipe::Pipelines::bcftools_merge with VRPipe::PipelineRole {
    ...
    method description {
        return 'Run bcftools merge split across the genome and then concatenate the result. Can also be used to pipe merged output through bcftools call for joint gVCF calling or to select certain alleles.';
    }
