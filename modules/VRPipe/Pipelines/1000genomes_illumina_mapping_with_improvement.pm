...
class VRPipe::Pipelines::1000genomes_illumina_mapping_with_improvement with VRPipe::PipelineRole {
    ...
    method _step_list {
        return ([ VRPipe::Step->get(name => 'sequence_dictionary'),#1
                  ...
                  VRPipe::Step->get(name => 'bam_stats')#18
                  ],
                 ...
                 [ VRPipe::StepAdaptorDefiner->new(from_step => 0, to_step => 3, to_key => 'fastq_files'),
                   ...
                   VRPipe::StepAdaptorDefiner->new(from_step => 11, to_step => 12, from_key => 'intervals_file', to_key => 'intervals_file'),
                   VRPipe::StepAdaptorDefiner->new(from_step => 9, to_step => 12, from_key => 'merged_lane_bams', to_key => 'bam_files'),
                   VRPipe::StepAdaptorDefiner->new(from_step => 12, to_step => 13, from_key => 'realigned_bam_files', to_key => 'bam_files'),
                   VRPipe::StepAdaptorDefiner->new(from_step => 12, to_step => 14, from_key => 'realigned_bam_files', to_key => 'bam_files'),
                   VRPipe::StepAdaptorDefiner->new(from_step => 14, to_step => 15, from_key => 'bam_recalibration_files', to_key => 'bam_recalibration_files'),
                   VRPipe::StepAdaptorDefiner->new(from_step => 12, to_step => 15, from_key => 'realigned_bam_files', to_key => 'bam_files'),
                   VRPipe::StepAdaptorDefiner->new(from_step => 15, to_step => 16, from_key => 'recalibrated_bam_files', to_key => 'bam_files'),
                   VRPipe::StepAdaptorDefiner->new(from_step => 16, to_step => 17, from_key => 'bq_bam_files', to_key => 'bam_files'),
                   VRPipe::StepAdaptorDefiner->new(from_step => 1, to_step => 17, from_key => 'reference_dict', to_key => 'dict_file'),
                   VRPipe::StepAdaptorDefiner->new(from_step => 17, to_step => 18, from_key => 'headed_bam_files', to_key => 'bam_files') 
                  ],
                 ...
                 [ VRPipe::StepBehaviourDefiner->new(after_step => 7, behaviour => 'delete_outputs', act_on_steps => [3, 5, 6], regulated_by => 'cleanup', default_regulation => 1),
                   ...
                   VRPipe::StepBehaviourDefiner->new(after_step => 12, behaviour => 'delete_outputs', act_on_steps => [9,10], regulated_by => 'remove_mapped_bams', default_regulation => 0),
                   VRPipe::StepBehaviourDefiner->new(after_step => 15, behaviour => 'delete_outputs', act_on_steps => [12,13,14], regulated_by => 'cleanup', default_regulation => 1),
