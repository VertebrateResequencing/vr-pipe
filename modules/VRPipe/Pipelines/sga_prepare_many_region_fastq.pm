...
VRPipe::Pipelines::sga_prepare_many_region_fastq - a pipeline
...
class VRPipe::Pipelines::sga_prepare_many_region_fastq with VRPipe::PipelineRole {
    method name {
        return 'sga_prepare_many_region_fastq';
    }
    ...
    method step_names {
        (
            ...
            'bam_metadata_many',   #2
            'bam_to_fastq_many',   #3
            'sga_preprocess_many', #4
            'fastq_metadata_many'  #5
        );
    }
