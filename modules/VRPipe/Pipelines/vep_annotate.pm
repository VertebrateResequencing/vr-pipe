...
class VRPipe::Pipelines::vep_annotate with VRPipe::PipelineRole {
    ...
    method adaptor_definitions {
        (
            { from_step => 0, to_step => 1, to_key   => 'var_file' },
            { from_step => 1, to_step => 2, from_key => 'vep_annot_var_file', to_key => 'vcf_files' },
        );
    }
    
    method behaviour_definitions {
        (
            { after_step => 1, behaviour => 'delete_inputs',  act_on_steps => [0], regulated_by => 'delete_input_vars', default_regulation => 0 },
