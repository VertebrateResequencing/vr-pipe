...
/*!50001 CREATE TABLE `latest_seq_request` (
  ...
  `ssid` mediumint(8) unsigned,
  `seq_type` enum('Illumina-A HiSeq Paired end sequencing','Illumina-B HiSeq Paired end sequencing','Illumina-C HiSeq Paired end sequencing','Single ended sequencing','Paired end sequencing','HiSeq Paired end sequencing','MiSeq sequencing','Single ended hi seq sequencing'),
...
CREATE TABLE `seq_request` (
  ...
  `ssid` mediumint(8) unsigned default NULL,
  `seq_type` enum('Illumina-A HiSeq Paired end sequencing','Illumina-B HiSeq Paired end sequencing','Illumina-C HiSeq Paired end sequencing','Single ended sequencing','Paired end sequencing','HiSeq Paired end sequencing','MiSeq sequencing','Single ended hi seq sequencing') NOT NULL,
...
-- Dump completed on 2012-08-28 14:09:35
