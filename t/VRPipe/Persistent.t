...
my @steps;
ok $steps[0] = VRPipe::Step->create(name => 'step_1',
                                 ...
                                 description => 'the first step'), 'created a Step using create()';
...
VRPipe::Step->create(name => "step_2",
                  ...
                  post_process_sub => sub { return 1 });
VRPipe::Step->create(name => "step_3",
                  ...
                  post_process_sub => sub { return 1 });
VRPipe::Step->create(name => "step_4",
                  ...
                  post_process_sub => sub { return 1 });
VRPipe::Step->create(name => "step_5",
