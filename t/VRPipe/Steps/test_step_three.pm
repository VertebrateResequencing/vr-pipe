...
class VRPipe::Steps::test_step_three with VRPipe::StepRole {
    method options_definition {
        return {
            all_option   => VRPipe::StepOption->create(description => 'an option that applies to all steps'),
            three_option => VRPipe::StepOption->create(
                description   => 'an optional option for step three with a default',
                optional      => 1,
    ...
    method inputs_definition {
        return {
            three_input => VRPipe::StepIODefinition->create(
                type        => 'txt',
    ...
    method outputs_definition {
        return {
            three_output => VRPipe::StepIODefinition->create(
                type        => 'txt',
