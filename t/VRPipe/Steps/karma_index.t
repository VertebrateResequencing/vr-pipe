...
my $setup = VRPipe::PipelineSetup->get(name => 'karma_setup',
                                       datasource => VRPipe::DataSource->get(type => 'fofn', method => 'all', source => file(qw(t data datasource.fofn))->absolute),
