...
my $setup = VRPipe::PipelineSetup->create(
    ...
    datasource  => VRPipe::DataSource->create(type => 'fofn', method => 'all', source => file(qw(t data hs_chr20.qc.bam.fofn))->absolute),
...
my @output_files;
my %bams = ('hs_chr20.a.bam' => 1, 'hs_chr20.b.bam' => 2, 'hs_chr20.c.bam' => 3, 'hs_chr20.d.bam' => 4);
