...
#my $file1 = VRPipe::File->create(path => file(qw(t data 2822_6_1.fastq))->absolute, metadata=>{});
#my $file2 = VRPipe::File->create(path => file(qw(t data 2822_6_2.fastq))->absolute, metadata=>{});
