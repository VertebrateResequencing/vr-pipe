...
class VRPipe::Steps::test_step_two with VRPipe::StepRole {
    method options_definition {
        return {
            ...
            two_option => VRPipe::StepOption->create(
                description => 'an optional option for step two',
                optional    => 1
            )
        };
    }
    ...
    method inputs_definition {
        return {
            two_input => VRPipe::StepIODefinition->create(
                type        => 'txt',
    ...
    method outputs_definition {
        return {
            two_output => VRPipe::StepIODefinition->create(
                type        => 'txt',
