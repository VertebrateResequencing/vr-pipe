...
is_deeply [VRPipe::StepState->create(pipelinesetup => 1, stepmember => 2, dataelement => 1)->cmd_summary->summary,
           ...
           VRPipe::StepState->create(pipelinesetup => 1, stepmember => 9, dataelement => 1)->cmd_summary->summary,
           VRPipe::StepState->create(pipelinesetup => 1, stepmember => 12, dataelement => 1)->cmd_summary->summary,
           VRPipe::StepState->create(pipelinesetup => 1, stepmember => 13, dataelement => 1)->cmd_summary->summary,
           ...
           VRPipe::StepState->create(pipelinesetup => 1, stepmember => 17, dataelement => 1)->cmd_summary->summary],
