...
is_deeply \@s_names, [qw(sequence_dictionary bwa_index bam_metadata bwa_aln_bam bwa_sam_using_bam sam_to_fixed_bam bam_reheader bam_stats)], 'the pipeline has the correct steps'; # bam_stats
