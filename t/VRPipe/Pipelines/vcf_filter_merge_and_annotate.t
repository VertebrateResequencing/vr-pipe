...
foreach my $in ('test1', 'test2') {
    ...
    push(@final_files, file(@output_subdirs, '4_vcf_consequences', "${in}.filt.${in}a.filt.merged.annot.conseq.vcf.gz"));
    push(@final_files, file(@output_subdirs, '4_vcf_consequences', "${in}.filt.${in}a.filt.merged.annot.conseq.vcf.gz.tbi"));
}
