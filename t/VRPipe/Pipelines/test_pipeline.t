...
is_deeply [scalar($ofile->slurp), scalar(VRPipe::File->get(path => file(output_subdirs(3, 2), '4_test_step_four', 'file3.txt.step_one.step_two.step_three.step_four'))->slurp)], [$expected_output, $expected_output], 'both runs of the pipeline gave good output files';
